        ...
        <div className="container mt-5 text-white">
            ...
            <div className="row align-items-center border-bottom border-secondary pb-4 mb-5">
                ...
                <div className="col-md-9 narrow-text p-4 rounded">
                    <h5 className="text-warning fw-bold mb-1">(Masters's) Aug. 2025 - May 2026</h5>
                    <div className="d-flex align-items-center mb-3">
                        ...
                        <h3 className="text-info mb-0">
                            Masters in Information Systems | Applied Data Analytics
                        </h3>
                    </div>

                    <p className="mb-1"><strong>School:</strong> Texas A&M Central Texas</p>
            ...
            <div className="row align-items-center border-bottom border-secondary pb-4 mb-5">
                <div className="col-md-9 narrow-text p-4 rounded">
                    <h5 className="text-warning fw-bold mb-1">(Bachelors's) Aug. 2023 - May 2025</h5>
                    <div className="d-flex align-items-center mb-3">
                        <img
                            src={tamuctLogo}
                            alt="Texas A&M Central Texas Logo"
                    ...
                    <p className="text-light mb-1"><strong>Focused on: </strong> </p>
                    <ul className="mb-1">
                        <li className="mb-1"><strong>Programming:</strong> Achieved expertise in programming languages such as Java, C++, C#, PHP, HTML, CSS and Java Script to create software applications and design websites for businesses. Similarly, become an expert in software development technologies such as Visual Studio and Visio.</li>
                        <li className="mb-1"><strong>Database Design and Development:</strong> Design and develop database applications using SQL, MySql, SQL Server, and PHP MyAdmin to create and manage databases.</li>
                        ...
                        <li className="mb-1"><strong>IT Project Management and Infrastructure:</strong> Plan, schedule and manage information technology resources. Also, learn to install, configure and maintain Windows- and Linux-based systems including enterprise systems and virtual systems. Design and set up corporate networks using tools such as Wireshark and Packet Tracer.</li>
            ...
            <div className="row align-items-center  pb-4 mb-5">
                <div className="col-md-9 narrow-text p-4 rounded">
                    <h5 className="text-warning fw-bold mb-1">(Associates) Aug. 2021 - May 2023</h5>
                    <div className="d-flex align-items-center mb-3">
                        <img
                            src={ctcLogo}
                        ...
                        />
                        <h3 className="text-info mb-0">
                            Interdisciplinary Studies | Focus in Computer Science and Mathematics
                        </h3>
                    </div>
                    <p className="mb-1"><strong>School:</strong> Central Texas College </p>
